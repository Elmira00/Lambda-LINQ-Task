...
class Program
{
    ...
    static void Main()
    {
        ...
        /*var myDebtors = debtors
             .Where(d => d.Email.EndsWith("rhyta.com") || d.Email.EndsWith("dayrep.com"))
             .ToList();
         myDebtors.ForEach(d => Console.WriteLine(d));*/


        //3) Yashi 26 - dan 36 - ya qeder olan borclulari cixartmag
        /*DateTime currentDate = DateTime.Now;
        var myDebtors = debtors
            .Where(d => ((int)((currentDate-d.BirthDay).TotalDays)/365)>=26 && ((int)((currentDate - d.BirthDay).TotalDays) / 365) <= 36)
            .ToList();
        myDebtors.ForEach(d => Console.WriteLine(d));*/
        ...
        //var myDebtors = debtors
        //    .Where(d => d.FullName.Length >= 18 || d.Phone.Count(p => p == '7') >= 2)
        //    .ToList();
        //myDebtors.ForEach(d => Console.WriteLine(d));
        ...
        //var totalDebt = debtors.Average(d => d.Debt);
        //var myDebtors = debtors
        //    .Where(d => d.Debt >= totalDebt)
        ...
        //DateTime currentDate = DateTime.Now;
        //var myDebtors = debtors
        //    .Where(d => (d.Phone.Contains("8") == false))
        //    .ToList();
        //myDebtors.ForEach(d => Console.WriteLine($"{d.FullName}--{((int)((currentDate - d.BirthDay).TotalDays) / 365)}" +
        //    $"--{d.Debt}"));
        ...
        //debtors.ForEach(d => d.FullName.ToLower());
        //var myDebtors = debtors
        //    .Where(d => d.FullName.Count(l => d.FullName.Split(l).Length>=4)>0 )
        //    .OrderBy(d => d.FullName)
        //    .ToList();
        //myDebtors.ForEach(d => Console.WriteLine(d));
        ...
        //var repeatedYear = debtors
        //    .GroupBy(d => d.BirthDay.Year)//verilen deyere gore qruplashdirir.
        //                 .OrderByDescending(d => d.Count())
        //                 .First().Key;
        //Console.WriteLine(repeatedYear);                
        ...
        //var myDebtorsDebtSum = debtors
        //    .Sum(d => d.Debt);
        //Console.WriteLine(myDebtorsDebtSum);
        ...
        //var myDebtors = debtors
        //   .Where(d => d.Phone.Count(n => d.Phone.IndexOf(n) == d.Phone.LastIndexOf(n))>10 )
        //   .ToList();
        //myDebtors.ForEach(d => Console.WriteLine(d));
        ...
        //DateTime currentDate = DateTime.Now;
        //var myDebtors = debtors
        //    .Where(d =>(Math.Abs((int )(d.BirthDay.Month - currentDate.Month))*500)>=d.Debt)
        //    .ToList();
        //myDebtors.ForEach(d => Console.WriteLine(d));
        ...
        //debtors.ForEach(d => d.FullName.ToLower());
        //var myDebtors = debtors
        //    .Where(d => d.FullName.Contains("s") && d.FullName.Contains("m") &&
        //    d.FullName.Contains("i") && d.FullName.Contains("l") && d.FullName.Contains("e"))
        //    .ToList();
        //myDebtors.ForEach(d => Console.WriteLine(d));
    }
}